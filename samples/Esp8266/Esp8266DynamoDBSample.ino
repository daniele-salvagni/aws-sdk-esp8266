...
const char* pSSID = "myssid"; // REPLACE with your network SSID (name)
const char* pPassword = "mypass"; // REPLACE with your network password (use for WPA, or use as key for WEP)
